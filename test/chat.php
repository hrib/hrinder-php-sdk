...
foreach($matches as $match){
      ...
      echo  '<font style="font-family:arial; font-size:7px;">' . $match->person->name . '</font>';
      ...
      echo '<input type="text" name="message" style="font-family:arial; font-size:7px; width: 600px;">';
